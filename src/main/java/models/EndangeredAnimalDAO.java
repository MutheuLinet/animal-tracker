...
public class EndangeredAnimalDAO implements EndangeredAnimalManagement{
    ...
    //read by selecting specific item from database
    @Override
    ...
    //read by selecting all from database
    @Override
    ...
    //delete by selecting specific item from database
    @Override
    ...
    //delete by selecting all from database
    @Override
